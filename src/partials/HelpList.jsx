        ...
        <div className="py-12 md:py-20">
          <div data-aos="fade-up" data-aos-delay="450">
                  ...
                  <div className="pl-6">
                    <header>
                      <h3 className="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">
                        <a href="#0">Intro to the Glyph Editor</a>
                      </h3>
                    </header>
              ...
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  ...
                  <div className="pl-6">
                    <header>
                      <h3 className="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">
                        <a href="#0">Overview of Model Filtering</a>
                      </h3>
                    </header>
                    <p className="text-gray-600 dark:text-gray-400">
                      Et leo duis ut diam quam nulla porttitor porttitor lacus
              ...
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  ...
                  <div className="pl-6">
                    <header>
                      <h3 className="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">
                        <a href="#0">How to: importing CSVs into a Project</a>
                      </h3>
                    </header>
                    <p className="text-gray-600 dark:text-gray-400">
                      Et leo duis ut diam quam nulla porttitor porttitor lacus
              ...
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  ...
                  <div className="pl-6">
                    <header>
                      <h3 className="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">
                        <a href="#0">How to: Fork a Model with Properties</a>
                      </h3>
                    </header>
                    <p className="text-gray-600 dark:text-gray-400">
                      Et leo duis ut diam quam nulla porttitor porttitor lacus
              ...
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  ...
                  <div className="pl-6">
                    <header>
                      <h3 className="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">
                        <a href="#0">How to: Projects and page passwords</a>
                      </h3>
                    </header>
                    <p className="text-gray-600 dark:text-gray-400">
                      Et leo duis ut diam quam nulla porttitor porttitor lacus
              ...
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  ...
                  <div className="pl-6">
                    <header>
                      <h3 className="font-red-hat-display text-xl font-extrabold tracking-tighter mb-1">
                        <a href="#0">Managing organization permissions</a>
                      </h3>
                    </header>
                    <p className="text-gray-600 dark:text-gray-400">
                      Et leo duis ut diam quam nulla porttitor porttitor lacus
            ...
            <nav className="flex justify-center sm:justify-between mt-12">
              <span
                className="hidden sm:inline-flex items-center font-medium text-gray-400 dark:text-gray-500"
                href="#0"
              >
                <svg
