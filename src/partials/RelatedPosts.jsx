                  ...
                  <header className="grow">
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">
                        The journey from green field to full fledged Data Ops
                      </h3>
                    </Link>
                    <div className="text-sm opacity-80">Nov 16, 2022</div>
                  </header>
                  <footer>
                    {/* Author meta */}
              ...
              >
                ...
                <div className="relative flex flex-col h-full">
                  <header className="grow">
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">
                        How to: Get started with data type recognition and
                        filtering
                      </h3>
                    </Link>
                    <div className="text-sm opacity-80">Nov 12, 2022</div>
                  </header>
                  <footer>
                    {/* Author meta */}
                    <div className="flex items-center text-sm mt-5">
