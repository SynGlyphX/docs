...
import CarouselImage01 from "../images/carousel-item-02.png";
import CarouselImage02 from "../images/carousel-item-02.png";
import CarouselImage03 from "../images/carousel-item-02.png";
import CarouselImage04 from "../images/carousel-item-02.png";
import CarouselImage05 from "../images/carousel-item-02.png";
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 font-red-hat-display mb-4">
              Getting started with Glyphx: Tutorials &{" "}
              <span className="text-teal-400">Guides</span>
            </h1>
