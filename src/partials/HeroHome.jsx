          ...
          <div className="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
            ...
            <div className="md:col-span-7 lg:col-span-7 mb-8 md:mb-0 text-center md:text-left">
              ...
              <p
                ...
                data-aos-delay="150"
              >
                Meaningfully visualize your data in 3D for the first time.
                Identify logistical opportunities your competitors might have
                missed.
              </p>
              {/* CTA form */}
              ...
              >
                <li className="flex items-center mb-2">
                  ...
                  <span>Rapid anomaly detection and identification</span>
                </li>
                <li className="flex items-center mb-2">
                  <svg
                    className="w-3 h-3 fill-current text-teal-400 mr-2 shrink-0"
                ...
                <li className="flex items-center mb-2">
                  ...
                  <span>Unlimited ETL Ingress</span>
                </li>
              </ul>
            </div>
            ...
            >
              <div className="inline-flex relative justify-center items-center">
                ...
                />
                {/* <svg className="absolute" width="290" height="624" style={{ maxWidth: '84.33%' }} alt="Features illustration" > */}
