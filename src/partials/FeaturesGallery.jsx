        ...
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4">
              We help teams by delivering intuitive data tools
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Exploring data has never been easier, the limits of 2D graphing
              are immediately apparent as soon as you see a glyph on the screen
            </p>
          </div>
