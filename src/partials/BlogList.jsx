...
import NewsImage01 from "../images/news-01.png";
import NewsImage02 from "../images/news-02.png";
import NewsImage03 from "../images/news-03.png";
import NewsImage04 from "../images/news-04.png";
import NewsImage05 from "../images/news-05.png";
import NewsImage06 from "../images/news-06.png";
              ...
              <div className="grid gap-12 sm:grid-cols-2 sm:gap-x-6 md:gap-y-8 items-start">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    ...
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                        How to get started using Glyphx?
                      </h3>
                    </Link>
                  </header>
                  ...
                  <footer className="flex items-center mt-4">
                    ...
                    <div className="text-sm text-gray-500">
                      ...
                      · <span className="text-gray-500">Oct 22, 2022</span>
                    </div>
                  </footer>
                </article>
                ...
                <article className="flex flex-col h-full">
                  <header>
                    ...
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                        Top 10 elements of a solid data strategy
                      </h3>
                    </Link>
                  </header>
                  <p className="text-gray-600 dark:text-gray-400 grow">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    ...
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                        Launch lessons: The data services @ Mosur IT
                      </h3>
                    </Link>
                  </header>
                  <p className="text-gray-600 dark:text-gray-400 grow">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    ...
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                        What to look for when monitoring 3PL data
                      </h3>
                    </Link>
                  </header>
                  <p className="text-gray-600 dark:text-gray-400 grow">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    ...
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                        If you haven’t been on board, the train has left the
                        station
                      </h3>
                    </Link>
                  </header>
                ...
                <article className="flex flex-col h-full">
                  <header>
                    ...
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                        Launch lessons: the experts behind robert weed
                      </h3>
                    </Link>
                  </header>
                  <p className="text-gray-600 dark:text-gray-400 grow">
                ...
                <ul className="-my-3">
                    ...
                    <article>
                      <Link className="hover:underline" to="/blog-post">
                        <h3 className="font-red-hat-display font-bold tracking-tight mb-1">
                          Guided Roadmap: How to get started using Glyphx?
                        </h3>
                      </Link>
                      <div className="text-sm text-gray-500">
                        By{" "}
                  ...
                  <li className="flex py-3 border-b border-gray-200 dark:border-gray-800">
                    ...
                    <article>
                      <Link className="hover:underline" to="/blog-post">
                        <h3 className="font-red-hat-display font-bold tracking-tight mb-1">
                          Create your data strategy in 4 simple steps
                        </h3>
                      </Link>
                      <div className="text-sm text-gray-500">
                        By{" "}
                        ...
                        · <span className="text-gray-500">Oct 17, 2022</span>
                      </div>
                    </article>
                  </li>
                  <li className="flex py-3 border-b border-gray-200 dark:border-gray-800">
                    ...
                    <article>
                      <Link className="hover:underline" to="/blog-post">
                        <h3 className="font-red-hat-display font-bold tracking-tight mb-1">
                          Don’t miss Glyphx’s exclusive workshop with our CEO
                        </h3>
                      </Link>
                      <div className="text-sm text-gray-500">
                        By{" "}
                        ...
                        · <span className="text-gray-500">Oct 2, 2022</span>
                      </div>
                    </article>
                  </li>
                  <li className="flex py-3 border-b border-gray-200 dark:border-gray-800">
                    ...
                    <article>
                      ...
                      <div className="text-sm text-gray-500">
                        ...
                        · <span className="text-gray-500">Sep 24, 2022</span>
                      </div>
                    </article>
                  </li>
                  <li className="flex py-3 border-b border-gray-200 dark:border-gray-800">
                    ...
                    <article>
                      <Link className="hover:underline" to="/blog-post">
                        <h3 className="font-red-hat-display font-bold tracking-tight mb-1">
                          What to do when you're stuck on a data problem
                        </h3>
                      </Link>
                      <div className="text-sm text-gray-500">
                        By{" "}
                        ...
                        · <span className="text-gray-500">Sep 22, 2022</span>
                      </div>
                    </article>
                  </li>
                </ul>
