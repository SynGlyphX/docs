                ...
                <header className="grow">
                  <Link className="hover:underline" to="/blog-post">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">
                      Pandemic supply chain lessons to heed
                    </h3>
                  </Link>
                </header>
                <footer>
                  <div className="text-sm opacity-80">
                    By Josh Wang · Nov 16, 2022
                  </div>
                </footer>
              </div>
            </article>
            ...
            >
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <Link className="hover:underline" to="/blog-post">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">
                      5 Ways to get control of your data
                    </h3>
                  </Link>
                </header>
                <footer>
                  <div className="text-sm opacity-80">
                    By Yuri Lapko · Nov 14, 2022
                  </div>
                </footer>
              </div>
            </article>
            ...
            >
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <Link className="hover:underline" to="/blog-post">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">
                      Data a major driver of 3PL success in 2022
                    </h3>
                  </Link>
                </header>
                <footer>
                  <div className="text-sm opacity-80">
                    By Josh Wang · Nov 10, 2022
                  </div>
                </footer>
              </div>
            </article>
            ...
            >
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <Link className="hover:underline" to="/blog-post">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">
                      Robust Data practices breed more sales
                    </h3>
                  </Link>
                </header>
                <footer>
                  <div className="text-sm opacity-80">
                    By Mary Champ · Nov 2, 2022
                  </div>
                </footer>
              </div>
            </article>
