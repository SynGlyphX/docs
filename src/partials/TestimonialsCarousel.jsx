...
function TestimonialsCarousel() {
  ...
  const [items] = useState([
    {
      quote:
        "“ When we first met Glyphx, we were skeptical. We tried lots of things before and none of them worked. But, when we tested the Shape Builder it just perfect for our needs. “",
      name: "Alexandre Park",
    ...
    {
      quote:
        "“ Not only in my career but in education as well, I feel grateful that Glyphx pushed me to expand my horizons and strive to accomplish more.“",
      name: "Greg Sebastian",
    ...
    {
      quote:
        "“ I feel grateful that Glyphx pushed me to expand my horizons and strive to accomplish more. When we first met Glyphx, we were skeptical for no reason.“",
      name: "Dominik Prasad",
