      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-xs mx-auto grid gap-6 sm:grid-cols-2 lg:grid-cols-4 items-start sm:max-w-none md:max-w-2xl lg:max-w-none">
            {/* Pricing table 1 */}
            <div
              className="flex flex-col h-full p-6 bg-white dark:bg-gray-800 shadow border-2 border-transparent dark:border-yellow-500"
              data-aos="fade-down"
            >
              <div className="grow mb-4 pb-4">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <div className="inline-flex px-3 py-1 text-xs font-medium text-teal-600 dark:text-yellow-400 bg-teal-200 dark:bg-yellow-600 dark:bg-opacity-25 rounded-full">
                    -40%
                  </div>
                </div>
              ...
              <div className="mt-24">
                <a
                  className="btn-sm text-white bg-yellow-500 hover:bg-teal-400 w-full"
                  href="#0"
                >
                  Go Premium
                </a>
            ...
            >
              ...
              <div className="mt-24">
                <a
                  className="btn-sm text-white bg-purple-500 hover:bg-purple-400 dark:text-yellow-400 dark:bg-gray-700 dark:hover:bg-gray-600 w-full"
                  href="#0"
                >
                  Go Premium
                </a>
